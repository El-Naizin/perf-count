...
use crate::PerfCounterBuilderError;
...
impl TryFrom<crate::event::Event> for HardwareEventType {
    type Error = PerfCounterBuilderError;

    fn try_from(value: crate::event::Event) -> Result<Self, PerfCounterBuilderError> {
        match value {
            crate::event::Event::CPUCycles => Ok(HardwareEventType::CPUCycles),
            crate::event::Event::Instructions => Ok(HardwareEventType::Instructions),
            crate::event::Event::CacheReferences => Ok(HardwareEventType::CacheReferences),
            crate::event::Event::CacheMisses => Ok(HardwareEventType::CacheMisses),
            crate::event::Event::BranchInstructions => Ok(HardwareEventType::BranchInstructions),
            crate::event::Event::BranchMisses => Ok(HardwareEventType::BranchMisses),
        }
    }
}
...
impl TryFrom<crate::event::Event> for SoftwareEventType {
    type Error = PerfCounterBuilderError;
...
impl PerfCounterBuilderLinux {
    ...
    pub fn set_hardware_event(mut self, event: HardwareEventType) -> PerfCounterBuilderLinux {
        self.attrs.attr_type = perf_event::PERF_TYPE_HARDWARE;
        self.attrs.config = event as u64;
        self
    }
    ...
    pub fn set_software_event(mut self, event: SoftwareEventType) -> PerfCounterBuilderLinux {
        self.attrs.attr_type = perf_event::PERF_TYPE_SOFTWARE;
        self.attrs.config = event as u64;
        self
    }
    ...
    pub fn set_flag_fd_output(&mut self) -> &mut PerfCounterBuilderLinux {
    ...
    pub fn set_flag_pid_cgroup(&mut self) -> &mut PerfCounterBuilderLinux {
        self.flags |= 0x04; //PERF_FLAG_PID_CGROUP;
        self
    }

    /// Add a sample period.
    pub fn set_sample_period(&mut self, period: u64) -> &mut PerfCounterBuilderLinux {
        self.attrs.sample_period_freq = period;
        self
    }

    /// Add a sample frequency.
    pub fn set_sample_frequency(&mut self, frequency: u64) -> &mut PerfCounterBuilderLinux {
    ...
    pub fn disable(&mut self) -> &mut PerfCounterBuilderLinux {
        self.attrs
            .settings
    ...
    pub fn inherit(&mut self) -> &mut PerfCounterBuilderLinux {
        self.attrs
            .settings
    ...
    pub fn pinned(&mut self) -> &mut PerfCounterBuilderLinux {
        self.attrs
            .settings
    ...
    pub fn exclusive(&mut self) -> &mut PerfCounterBuilderLinux {
        self.attrs
            .settings
    ...
    pub fn exclude_user(&mut self) -> &mut PerfCounterBuilderLinux {
        self.attrs
            .settings
    ...
    pub fn exclude_kernel(&mut self) -> &mut PerfCounterBuilderLinux {
        self.attrs
            .settings
    ...
    pub fn exclude_hv(&mut self) -> &mut PerfCounterBuilderLinux {
        self.attrs
            .settings
    ...
    pub fn exclude_idle(&mut self) -> &mut PerfCounterBuilderLinux {
        self.attrs
            .settings
    ...
    pub fn enable_mmap(&mut self) -> &mut PerfCounterBuilderLinux {
    ...
    pub fn inherit_stat(&mut self) -> &mut PerfCounterBuilderLinux {
        self.attrs
            .settings
    ...
    pub fn enable_on_exec(&mut self) -> &mut PerfCounterBuilderLinux {
        self.attrs
            .settings
    ...
    pub fn enable_task_notification(&mut self) -> &mut PerfCounterBuilderLinux {
    ...
    pub fn enable_watermark(&mut self, watermark_events: u32) -> &mut PerfCounterBuilderLinux {
        self.attrs
            .settings
    ...
    pub fn set_ip_sample_arbitrary_skid(&mut self) -> &mut PerfCounterBuilderLinux {
        self.attrs
            .settings
    ...
    pub fn set_ip_sample_constant_skid(&mut self) -> &mut PerfCounterBuilderLinux {
        self.attrs
            .settings
    ...
    pub fn set_ip_sample_req_zero_skid(&mut self) -> &mut PerfCounterBuilderLinux {
        self.attrs
            .settings
    ...
    pub fn enable_mmap_data(&mut self) -> &mut PerfCounterBuilderLinux {
        self.attrs
            .settings
    ...
    pub fn set_ip_sample_zero_skid(&mut self) -> &mut PerfCounterBuilderLinux {
        self.attrs
            .settings
    ...
    pub fn enable_read_format_time_enabled(&mut self) -> &mut PerfCounterBuilderLinux {
        self.attrs
            .read_format
    ...
    /// and  multiplexing is happening.
    pub fn enable_read_format_time_running(&mut self) -> &mut PerfCounterBuilderLinux {
        self.attrs
            .read_format
    ...
    pub fn enable_read_format_id(&mut self) -> &mut PerfCounterBuilderLinux {
        self.attrs.read_format.insert(ReadFormatFlags::FORMAT_ID);
        self
    }

    /// Allows all counter values in an event group to be read with one read.
    pub fn enable_read_format_group(&mut self) -> &mut PerfCounterBuilderLinux {
        self.attrs.read_format.insert(ReadFormatFlags::FORMAT_GROUP);
        self
    }

    pub fn enable_sampling_ip(&mut self) -> &PerfCounterBuilderLinux {
        self.attrs
            .sample_type
    ...
    pub fn enable_sampling_tid(&mut self) -> &PerfCounterBuilderLinux {
        self.attrs
            .sample_type
    ...
    pub fn enable_sampling_time(&mut self) -> &PerfCounterBuilderLinux {
        self.attrs
            .sample_type
    ...
    pub fn enable_sampling_addr(&mut self) -> &PerfCounterBuilderLinux {
        self.attrs
            .sample_type
    ...
    pub fn enable_sampling_read(&mut self) -> &PerfCounterBuilderLinux {
        self.attrs
            .sample_type
    ...
    pub fn enable_sampling_callchain(&mut self) -> &PerfCounterBuilderLinux {
        self.attrs
            .sample_type
    ...
    pub fn enable_sampling_sample_id(&mut self) -> &PerfCounterBuilderLinux {
        self.attrs
            .sample_type
    ...
    pub fn enable_sampling_cpu(&mut self) -> &PerfCounterBuilderLinux {
        self.attrs
            .sample_type
    ...
    pub fn enable_sampling_period(&mut self) -> &PerfCounterBuilderLinux {
        self.attrs
            .sample_type
    ...
    pub fn enable_sampling_stream_id(&mut self) -> &PerfCounterBuilderLinux {
        self.attrs
            .sample_type
    ...
    pub fn enable_sampling_raw(&mut self) -> &PerfCounterBuilderLinux {
        self.attrs
            .sample_type
    ...
    pub fn enable_sampling_branch_stack(&mut self) -> &PerfCounterBuilderLinux {
        self.attrs
            .sample_type
    ...
    pub fn enable_sampling_regs_user(&mut self) -> &PerfCounterBuilderLinux {
        self.attrs
            .sample_type
    ...
    pub fn enable_sampling_stack_user(&mut self) -> &PerfCounterBuilderLinux {
        self.attrs
            .sample_type
    ...
    pub fn enable_sampling_sample_weight(&mut self) -> &PerfCounterBuilderLinux {
        self.attrs
            .sample_type
    ...
    pub fn enable_sampling_data_src(&mut self) -> &PerfCounterBuilderLinux {
        self.attrs
            .sample_type
    ...
    pub fn enable_sampling_identifier(&mut self) -> &PerfCounterBuilderLinux {
        self.attrs
            .sample_type
    ...
    pub fn enable_sampling_transaction(&mut self) -> &PerfCounterBuilderLinux {
        self.attrs
            .sample_type
    ...
    pub fn for_all_pids(&mut self) -> &mut PerfCounterBuilderLinux {
        self.pid = -1;
        self
    }

    /// Measure for a specific PID.
    pub fn for_pid(&mut self, pid: i32) -> &mut PerfCounterBuilderLinux {
        self.pid = pid;
        self
    }

    /// Pin counter to CPU.
    pub fn on_cpu(&mut self, cpu: isize) -> &mut PerfCounterBuilderLinux {
        self.cpu = cpu;
        self
    }

    /// Measure on all CPUs.
    pub fn on_all_cpus(&mut self) -> &mut PerfCounterBuilderLinux {
        self.cpu = -1;
        self
    }

    pub fn finish_sampling_counter(&self) -> Result<PerfCounter, Error> {
    ...
    pub fn finish(&self) -> Result<PerfCounter, Error> {
        let fd = perf_event_open(
            &self.attrs,
            self.pid,
            self.cpu as i32,
...
impl PerfCounter {
    ...
    pub fn read_fd(&mut self) -> Result<FileReadFormat, Error> {
        unsafe {
...
impl PerfCounter {
    ...
    pub fn read(&mut self) -> Result<u64, Error> {
